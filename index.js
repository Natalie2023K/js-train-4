...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  const result = String.fromCharCode (code1, code2, code3, code4, code5);
  return result;
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  const result = String.fromCodePoint(code1, code2, code3, code4);
  return result;
...
function compareCharCodeAtAndCodePointAt(string, index) {
 ...
 const charCodeAtResult = string.charCodeAt(string);
 const codePointAtResult = string.codePointAt(string);
...
function sliceString(string, startIndex, endIndex) {
  return string.slice(sliceString, endIndex);
